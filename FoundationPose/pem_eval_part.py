...
def main():
    ...
    parser.add_argument('--scenes_root', type=str,
        default="/home/martyn/Thesis/pose-estimation/data/scenes/scenes_part/",
        help="Root directory containing scene_01, scene_02, ... scene_10"
    )
    parser.add_argument('--output_root', type=str,
        default="/home/martyn/Thesis/pose-estimation/results/part/methods/test_foundationpose/",
        help="Root directory for saving results"
    )
    parser.add_argument('--num_scenes', type=int, default=10, help="Number of scenes to process")
    parser.add_argument('--runs_per_scene', type=int, default=5, help="Number of runs per scene")
    args = parser.parse_args()

    # Constants
    mesh_path = "/home/martyn/Thesis/pose-estimation/data/cad-models/part.ply"
