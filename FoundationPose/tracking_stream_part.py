...
point_cloud_file = "/home/martyn/Thesis/pose-estimation/data/point-clouds/A6544132042_003_point_cloud_scaled.ply"  # Replace with your point cloud file
...
output_video_path = "/home/martyn/Thesis/pose-estimation/FoundationPose-Video/output_video.mp4"  # Replace with your desired file path
...
first_frame_path = "/home/martyn/Thesis/pose-estimation/FoundationPose-Image/first_frame.png"  # Replace with your desired path
...
try:
    while Estimating:
        ...
        vis = project_and_draw_points(
            ...
            alpha=0.5                      # Transparency level (50% opaque)
        )
